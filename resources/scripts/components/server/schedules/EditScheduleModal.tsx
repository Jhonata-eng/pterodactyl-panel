            ...
            {({ isSubmitting }) => (
                <Form>
                    ...
                    <p css={tw`text-neutral-400 text-xs mt-2`}>
                        O sistema de agendamento suporta o uso da sintaxe Cronjob ao definir quando as tarefas devem
                        começar a ser executadas. Use os campos acima para especificar quando essas tarefas devem
                    ...
                    <div css={tw`mt-6 bg-neutral-700 border border-neutral-800 shadow-inner p-4 rounded`}>
                        <FormikSwitch
                            name={'onlyWhenOnline'}
                            description={'Execute este agendamento somente quando o servidor estiver em execução.'}
                            label={'Somente quando o servidor estiver online'}
                        />
                    </div>
                    <div css={tw`mt-6 bg-neutral-700 border border-neutral-800 shadow-inner p-4 rounded`}>
                        <FormikSwitch
                            name={'enabled'}
                            description={'Este agendamento será executada automaticamente se estiver ativada.'}
