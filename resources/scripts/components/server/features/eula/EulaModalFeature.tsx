...
const EulaModalFeature = () => {
    ...
    useEffect(() => {
        ...
        const listener = (line: string) => {
            if (line.toLowerCase().indexOf('Você precisa aceitar o EULA para executar o servidor.') >= 0) {
                setVisible(true);
            }
        };
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Aceitar EULA Minecraft&reg;</h2>
            <p css={tw`text-neutral-200`}>
                Ao clicar em {'"Aceito"'} abaixo, você indica sua concordância com os termos&nbsp;
                <a
                    target={'_blank'}
