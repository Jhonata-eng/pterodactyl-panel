    ...
    return (
        <>
            <Formik onSubmit={submit} initialValues={{ confirm: '' }} validationSchema={schema} isInitialValid={false}>
                {({ isSubmitting, isValid, resetForm }) => (
                    ...
                    >
                        ...
                        <p css={tw`text-sm`}>
                            Excluir um banco de dados é uma ação permanente, não pode ser desfeita. Isso excluirá
                            permanentemente o banco de dados <strong>{database.name}</strong> e removerá todos os dados
                            associados.
                        </p>
            ...
            <Modal visible={connectionVisible} onDismissed={() => setConnectionVisible(false)}>
                ...
                <h3 css={tw`mb-6 text-2xl`}>Detalhes da conexão com o banco de dados</h3>
                <div>
                ...
                <div css={tw`mt-6`}>
                    <Label>Origem das conexões</Label>
                ...
                <div css={tw`mt-6`}>
                    <Label>Cadeia de conexão JDBC</Label>
            ...
            <GreyRowBox $hoverable={false} className={className} css={tw`mb-2`}>
                ...
                <div css={tw`ml-8 text-center hidden md:block`}>
                    ...
                    <p css={tw`mt-1 text-2xs text-neutral-500 uppercase select-none`}>Origem da conexão</p>
                </div>
                <div css={tw`ml-8 text-center hidden md:block`}>
                    <CopyOnClick text={database.username}>
                        <p css={tw`text-sm`}>{database.username}</p>
                    </CopyOnClick>
                    <p css={tw`mt-1 text-2xs text-neutral-500 uppercase select-none`}>Nome de usuário</p>
                </div>
                <div css={tw`ml-8`}>
