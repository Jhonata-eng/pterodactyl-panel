...
const JavaVersionModalFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Versão do Java não suportada</h2>
            <p css={tw`mt-4`}>
                Este servidor está executando uma versão não suportada do Java e não pode ser iniciado.
                <Can action={'startup.docker-image'}>
                    &nbsp;Selecione uma versão compatível na lista abaixo para continuar a iniciar o servidor.
                </Can>
            </p>
            <Can action={'startup.docker-image'}>
                <div css={tw`mt-4`}>
