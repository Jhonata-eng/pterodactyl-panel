...
export default () => {
    ...
    return status === 'installing' || status === 'install_failed' || status === 'reinstall_failed' ? (
        ...
        <ScreenBlock
            ...
            message={
                isTransferring
                    ? 'Seu servidor está sendo transferido para um novo node, por favor volte mais tarde.'
                    : 'Seu servidor está sendo restaurado a partir de um backup, por favor tente novamente em alguns minutos.'
            }
        />
    );
};
