        ...
        <Formik
            ...
            validationSchema={object().shape({
                email: string()
                    ...
                    .email('Um endereço de e-mail válido deve ser informado.')
                    .required('Um endereço de e-mail válido deve ser informado.'),
                ...
                {!isRootAdmin && loggedInPermissions[0] !== '*' && (
                    <div css={tw`mt-4 pl-4 py-2 border-l-4 border-cyan-400`}>
                        <p css={tw`text-sm text-neutral-300`}>
                            Somente as permissões que estão atualmente atribuídas à sua conta podem ser selecionadas ao
                ...
                {!subuser && (
                    <div css={tw`mt-6`}>
                        <Field
                            ...
                            description={
                                'Insira o endereço de e-mail do usuário que você deseja convidar como subusuário para este servidor.'
                            }
                        />
                    </div>
                )}
