        ...
        <Formik onSubmit={updateGSLToken} initialValues={{ gslToken: '' }}>
            ...
            >
                ...
                <Form>
                    ...
                    <p css={tw`mt-4`}>
                        Parece que seu token de login do servidor de jogos (token GSL) é inválido ou expirou.
                    </p>
                    <p css={tw`mt-4`}>
                        Você pode gerar um novo e inseri-lo abaixo ou deixar o campo em branco para removê-lo
                        completamente.
                    </p>
