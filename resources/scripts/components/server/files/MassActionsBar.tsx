...
const MassActionsBar = () => {
    ...
    const onClickConfirmDeletion = () => {
        ...
        clearFlashes('files');
        setLoadingMessage('Deletando arquivos...');
            ...
            <div css={tw`pointer-events-none fixed bottom-0 z-20 left-0 right-0 flex justify-center`}>
                ...
                >
                    <p className={'mb-2'}>
                        ...
                        <span className={'font-semibold text-gray-50'}>{selectedFiles.length} arquivos</span>? Esta é
                        uma ação permanente e os arquivos não poderão ser recuperados.
                    </p>
