...
const schema = object().shape({
    databaseName: string()
        .required('É necessário fornecer o nome do banco de dados.')
        ...
        .matches(
            /^[\w\-.]{3,48}$/,
            'O nome do banco de dados deve conter apenas caracteres alfanuméricos, sublinhados, hífens e/ou pontos.'
        ),
    connectionsFrom: string().matches(/^[\w\-/.%:]+$/, 'É necessário fornecer um endereço de host válido.'),
});
